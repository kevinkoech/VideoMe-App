...
import java.io.IOException;
    ...
    public class AudioPlayer {
                ...
                case AudioManager.RINGER_MODE_NORMAL:
                    ...
                    try {
                        mPlayer.setDataSource(mContext,
                                Uri.parse("android.resource://" + mContext.getPackageName() + "/" + R.raw.army_wake_up));
                        mPlayer.prepare();
                    } catch (IOException e) {
        ...
        private static AudioTrack createProgressTone(Context context) throws IOException {
            AssetFileDescriptor fd = context.getResources().openRawResourceFd(R.raw.sister_is_calling);
